...
public static class HelperUtilities
{
    ...
    /// </summary>
    public static bool ValidateCheckPositiveRange(UnityEngine.Object thisObject, string fieldNameMinimum, float valueToCheckMinimum, string fieldNameMaximum, float valueToCheckMaximum, bool isZeroAllowed)
    {
        bool error = false;
